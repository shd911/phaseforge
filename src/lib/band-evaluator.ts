...
// b140.14: `buildLogGrid` and `buildCommonGrid` moved to
// ./band-evaluator/grid.ts and re-imported above. Behaviour unchanged.
...
// b140.14.2: `computeExtension` moved to ./band-evaluator/extension.ts
// and re-imported above. Behaviour unchanged.
