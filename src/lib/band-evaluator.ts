...
import { appendNoiseFloorTail, autoRefLevel, computeExtension } from "./band-evaluator/extension";
...
// b140.14.3: `evaluateSum`, its 4 helpers (coherentSum, powerSumDb,
// applyGlobalShiftIfWideExcess, resampleOntoCommon), and the
// SumEvalResult / SumEvalOptions types moved to ./band-evaluator/sum.ts.
// Re-exported here for backward compat — existing callers (FrequencyPlot,
// tests) keep `import { evaluateSum } from "../band-evaluator"`.
